...
export function HeroContent() {
  return (
    <div className="pointer-events-none absolute left-[-40px] top-[88px] z-30 w-[840px]">
      <div className="mb-6 flex items-center gap-3 text-[#7e22ce]">
      ...
      <div className="mt-8 flex w-[715px] items-start gap-5">
